...
function toggle_able_btn(button, is_enabled) {
...
function toggle_all_able_btn() {
    ...
    const majority_true = enabled.filter(Boolean).length > enabled.length / 2;
    toggle_able_btn(able_all_btn, !majority_true);
}
export function toggle_hide_mode(is_mode_goal) {
